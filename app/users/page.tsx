...
import { UserPlus, Users, Edit, Trash2, ArrowLeft, Shield, User, Settings, Eye, EyeOff } from "lucide-react"
          ...
          updatedList = usersList.map((userData) =>
            userData.id === editingId
              ? {
                  ...
                  role: formData.role as "admin" | "masul_tahfidz" | "tim_tahfidz",
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-2">Hanya Admin yang dapat mengelola pengguna.</p>
        </div>
      </div>
    )
  }
          ...
          <FadeIn delay={0.1}>
            <div className="mb-8">
              ...
              <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-8 text-white shadow-xl">
                ...
                <p className="text-indigo-100">Kelola akun pengguna dan hak akses sistem</p>
              </div>
            </div>
          </FadeIn>
              ...
              <AnimatedCard className="border-0 shadow-xl">
                <CardHeader className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-t-lg">
                  ...
                  <CardDescription className="text-indigo-100">
                    {isEditing ? "Perbarui data pengguna" : "Buat akun pengguna baru"}
                  </CardDescription>
                </CardHeader>
            ...
            <FadeIn delay={0.4}>
              <AnimatedCard className="border-0 shadow-xl">
                <CardHeader className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-t-lg">
                  ...
                  <CardDescription className="text-blue-100">Semua pengguna yang terdaftar</CardDescription>
                </CardHeader>
                <CardContent className="p-6">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <div className="flex items-center gap-2">
                                  ...
                                  <Badge className={getRoleColor(userData.role)}>{getRoleName(userData.role)}</Badge>
                                  <Badge
                                ...
                                <p className="text-xs text-gray-500">
                                  Dibuat: {new Date(userData.createdAt).toLocaleDateString("id-ID")}
                                </p>
                              </div>
                            </div>
